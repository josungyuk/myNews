...
parameters = [
    ...
    # (ct.NewsSource.GUARDIAN, ct.news_organ_homepage[(ct.NewsSource.GUARDIAN)], ct.news_organ_type[ct.NewsSource.GUARDIAN][ct.NewsType.ECONOMY], ct.news_organ_content_tag[(ct.NewsSource.GUARDIAN)]),
    (ct.NewsSource.NPR, ct.news_organ_homepage[(ct.NewsSource.NPR)], ct.news_organ_type[ct.NewsSource.NPR][ct.NewsType.ECONOMY], ct.news_organ_content_tag[(ct.NewsSource.NPR)]),
