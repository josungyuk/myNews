...
parameters = [
    ...
    (ct.NewsSource.GUARDIAN, ct.news_organ_homepage[(ct.NewsSource.GUARDIAN)], ct.news_organ_type[ct.NewsSource.GUARDIAN][ct.NewsType.SOCIETY], ct.news_organ_content_tag[(ct.NewsSource.GUARDIAN)]),
